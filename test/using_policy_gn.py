...
def discount_and_nomalize_rewards (all_rewards, discount_rate):
...
with tf.Session() as sess:
    ...
    for iteration in range(num_iterations):
        ...
        all_rewards = discount_and_nomalize_rewards(all_rewards,discount_rate)
        feed_dict = {}
...
print("Saving Graphs and session")
meta_graph_def = tf.train.export_meta_graph(filename = '/models/trained_model.meta')
saver.save(sess, '/model/trained_model.meta')
